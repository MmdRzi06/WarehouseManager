namespace WarehouseManager {
	partial class FormAddAirCooler {
		/// <summary>
		...
		private void InitializeComponent() {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FormAddAirCooler));
			...
			tbxCoolerHeight.Location = new Point(339, 377);
			...
			panelBenchMarkInfo.TabIndex = 105;
			// 
			// tbxMaximumScore
			// 
			...
			tbxMaximumFanSpeed.TabIndex = 101;
			...
			lblMaximumFanSpeed.TabIndex = 100;
			...
			tbxMinimumFanSpeed.TabIndex = 99;
			...
			lblMinimumFanSpeed.TabIndex = 98;
